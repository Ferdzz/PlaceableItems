...
public class ModBlocks {
	...
	public static void init() {
		...
		blockLavaBucket = new BlockFilledBucket("block_lava_bucket").setBucketItem(Items.LAVA_BUCKET).setItem(Items.LAVA_BUCKET).setBoundingBox(1, 0, 1, 15, 14, 15).setLightLevel(1.5F);
		...
		blockBeetrootSoup = new BlockSoup("block_beetroot_soup", 6, 1.2F).setItem(Items.BEETROOT_SOUP).setBoundingBox(2, 0, 2, 14, 3, 14);
		...
		blockCookie = new BlockCookie("block_cookie", 2, 0.2F).setItem(Items.COOKIE).setBoundingBox(3, 0, 3, 13, 4, 13);
		...
		blockChorusFruit = new BlockChorusFruit("block_chorus_fruit", 4, 2.4F).setItem(Items.CHORUS_FRUIT).setBoundingBox(3, 10, 3);
		blockChorusPopped = new BlockFaceable("block_chorus_popped").setItem(Items.CHORUS_FRUIT_POPPED).setBoundingBox(3, 10, 3);
