...
public class ModBlocks {
	...
	public static void init() {
		...
		blockChorusFruit = new BlockChorusFruit("block_chorus_fruit", 4, 2.4F).setItem(Items.CHORUS_FRUIT).setBoundingBox(3, 7, 3);
		blockChorusPopped = new BlockFaceable("block_chorus_popped").setItem(Items.CHORUS_FRUIT_POPPED).setBoundingBox(3, 7, 3);
